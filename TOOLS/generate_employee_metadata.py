...
def _build_stamina_policy(effect_ids: list[str], humanball_ids: list[str]) -> dict[str, Any]:
    return {
        ...
        "tuning_status": "initial_runtime_tuning_author_review_pending",
        "normal_work_loop_ms": 720,
        "critical_home_policy": "queue_at_critical_then_finish_current_normal_work_loop",
        "emotion_effects": {
            "sad": {"display_delta": -1, "milli_delta": -1000},
            "happy": {"display_delta": 2, "milli_delta": 2000},
            "owner": "CentralGameCore.actor_snapshot",
        },
        ...
        "recovery_events": {
            "talk": {
                ...
                "selection_weight": 56,
                "runtime_status": "implemented_runtime_binding",
            ...
            "wander": {
                ...
                "selection_weight": 0,
                "runtime_status": "retired_from_automatic_selection_legacy_snapshot_only",
                "visual_channel": "legacy_move_snapshot_only",
            },
        },
        "home_policy": {
